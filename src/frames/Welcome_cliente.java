...
public class Welcome_cliente extends javax.swing.JFrame {
    ...
    private void btnCrearPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearPedidoActionPerformed
        ...
        for (int i = 0; i < 100; i++) {
            int platillo=(int)(Math.random()*29);
            switch (platillo) {
                case 0:
                ...
                case 9:
                    ...
                    break;
                case 10:
                    ListaPlatillo.contiene("Suchi");
                    break;
                case 11:
                    ListaPlatillo.contiene("Ramen");
                    break;
                case 12:
                    ListaPlatillo.contiene("Yakitori");
                    break;
                case 13:
                    ListaPlatillo.contiene("Onigiri");
                    break;
                case 14:
                    ListaPlatillo.contiene("Sashimi");
                    break;
                case 15:
                    ListaPlatillo.contiene("Soba");
                    break;
                case 16:
                    ListaPlatillo.contiene("Takoyaki");
                    break;
                case 17:
                    ListaPlatillo.contiene("Katsudon");
                    break;
                case 18:
                    ListaPlatillo.contiene("Tempura");
                    break;
                case 19:
                    ListaPlatillo.contiene("Monjayaki");
                    break;
                case 20:
                    ListaPlatillo.contiene("Pizza");
                    break;
                case 21:
                    ListaPlatillo.contiene("Pasta");
                    break;
                case 22:
                    ListaPlatillo.contiene("Resoto");
                    break;
                case 23:
                    ListaPlatillo.contiene("Lasaña");
                    break;
                case 24:
                    ListaPlatillo.contiene("Ravioles");
                    break;
                case 25:
                    ListaPlatillo.contiene("Panna Cotta");
                    break;
                case 26:
                    ListaPlatillo.contiene("Gelato");
                    break;
                case 27:
                    ListaPlatillo.contiene("Carpaccio");
                    break;
                case 28:
                    ListaPlatillo.contiene("Tiramisu");
                    break;
                case 29:
                    ListaPlatillo.crearCapresse();
                    ListaPlatillo.contiene("Ensalada Capresse");
                    break;
                default:
